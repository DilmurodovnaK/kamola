...
const Projects = () => {
  ...
  return (
    <div  data-aos="fade-down" data-aos-easing="linear"
     data-aos-duration="800" id="projects" className=" w-full pt-6 mb-10 ms:pt-6 md:pt-0  ">
...
className="font-bold pacifico-regular text-[30px] text-[#781727] text-center" >
      ...
      <div className="flex px-20 items-center ms:mt-6 mt-12 justify-between xl:gap-x-7 xl:px-12 md:gap-3 lg:px-8 md:flex-col nb:px-5 md:items-center">
        <div className=" w-[48%]  md:w-[100%]">
          <a href="https://fom-clinic.uz">
             ...
             <div className=" w-[48%]  md:w-[100%]">
          <a href="https://shakhzodaf.vercel.app/">
